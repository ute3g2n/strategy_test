...
状態: `DESIGN_COMPLETE_FOR_REVIEW / P5R2-H1_UNAPPROVED`。これは実装、RED/GREEN、品質Run、外部通信、物理削除の証拠ではない。P5Rの既存Evidence/Test/Manualは履歴参照だけであり、P5R2の合否証拠へ昇格しない。

| atomic Requirement | 下位Requirement | 主設計書 | 実装前に固定する契約 | Test雛形の責務 | Gate / Unknown |
|---|---|---|---|---|---|
| P5R2-CREQ-TF-001 | TF-001, TF-004 | 01 | 5戦略足、UTC anchor、closed bar、有効終了 | 選択肢、1m拒否、30m、partial拒否 | H1、UNK-TF-004 |
| P5R2-CREQ-TF-002 | TF-002, TF-005, TF-006 | 01, 02, 05 | 1m source/derived分離、補間、生成遷移 | 補間の正負例、生成入力引継ぎ | H1、UNK-TF-004/006 |
| P5R2-CREQ-TF-003 | TF-003, TF-004 | 01, 04, 05 | legacyを閲覧専用に分離 | legacyを新規Runへ渡さない | H1 |
| P5R2-CREQ-HD-001 | HD-001, HD-002 | 02, 04, 05 | Download/Generationの別ID・別状態 | Gate前無通信、Job/DataSet分離 | H1、DATA-G1 |
| P5R2-CREQ-HD-002 | HD-003～HD-007 | 02, 04, 05 | identity、coverage、quality、promotion | dedupe/conflict/merge/replace/recovery | H1、UNK-TF-006 |
| P5R2-CREQ-RUN-001 | RUN-001, RUN-002 | 03, 04, 05 | 3画面共通cancel、OperationGuard、terminal不変 | 二重押下、再送、別tab、再起動 | H1 |
| P5R2-CREQ-RUN-002 | RUN-003, RUN-004 | 03, 04, 05 | Artifact状態、論理ID、安全な許可root | traversal/symlink/reparse/TOCTOU/CSV保護 | H1、DELETE-G1 |
| P5R2-CREQ-DOC-001 | AUDIT-001, DOC-001, GATE-001 | 05（横断01～04） | DTO、dialog、a11y、Manual/Evidence registry | UI/Manualの未実証拒否 | H1、H2、UNK-QG-001/002 |
...
| P5R2-UNK-TF-004 | 補間候補のAPI/Persistence/negative testへの最終写像 | 01, 02 | H1 packet前。未決なら候補外Dataをusable/Run入力へしない |
| P5R2-UNK-TF-006 | 「現在生成可能な全期間」の算出規則 | 01, 02, 05 | H1 packet前。未決なら既定期間を表示・実装しない |
| P5R2-UNK-QG-001 | P5R2 Quality namespaceと固定入口 | 05 | H1前。未登録Run/test subprocessをしない |
| P5R2-UNK-QG-002 | fixtureと保護境界 | 04, 05 | H1前。未確認fixtureを使わず、管理目的の同一性照合経路も作らない |
...
再レビュー判定: `Critical=0 / High=0 / Medium=0 / Low=0`。P5R2-UNK-TF-004、P5R2-UNK-TF-006、P5R2-UNK-QG-001、P5R2-UNK-QG-002、H1、DATA-G1、DELETE-G1、H2はOpenのままであり、Passではない。
