...
状態: `READ_ONLY_INPUT / P5R2-HREQ_APPROVED / P5R2-H1_APPROVED_BY_DELEGATED_AUTHORITY / P5R2-H2_APPROVED_BY_DELEGATED_AUTHORITY / P5R2-COMPLETE_WITH_OPEN_UNKNOWN`。これは入力整理成果物の現在同期状態であり、P5R2-08作成時点のH1未承認という履歴はログへ保持する。根拠は `AT-REQ-004 v4.0`、`P5R2-PLAN-002 v0.2`、P5R/P5R2のHTML・既存ソース・UI・Test・Manual、P5R2-25完了Evidenceである。P5Rの完了は履歴であり、P5R2のOpen UnknownをPassへ変換しない。
...
|手順書|`P5R2-CREQ-DOC-001`|AUDIT-001, DOC-001, GATE-001|`doc/phase5R/07_運用手順/01_バックテスト手順書.html`|実装済み・検証済み操作だけをP5R2-22で改訂し、P5R2-H2承認後にP5R2-25でCurrent同期|P6-H0未承認のためP6開始根拠へ読み替えない|
...
|---|---|---|---|
|`P5R2-UNK-TF-004`|H1判断済み、P5R2-13 local evidence、P5R2-H2承認済み（Open Unknown保持）。owner: P5R2詳細設計責任者＋root承認者|候補外Dataのusable昇格・Run入力を禁止|`doc/requirements/01_自動トレードシステム要件定義書_v4.html`、P5R2-13 GREEN、P5R2-22 Manual evidence、P5R2-H2 packet、P5R2-25 completion Evidence|
|`P5R2-UNK-TF-006`|H1判断済み、P5R2-13／14／22 local evidence、P5R2-H2承認済み（Open Unknown保持）。owner: P5R2詳細設計責任者＋root承認者|sourceなし・品質未承認の既定期間表示・送信を禁止|同v4、P5R2-13／14 GREEN、P5R2-22 Manual evidence、P5R2-H2 packet、P5R2-25 completion Evidence|
