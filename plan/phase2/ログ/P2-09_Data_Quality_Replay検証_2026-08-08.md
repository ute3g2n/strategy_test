...
- fixture data_version: `dv_0d5783c4a39b4547c8d0`
- Data Quality matrix: PASS（異常はfail-closed）
- Replay: PASS（fixture限定でManifest・MarketEvent系列を再現）
- 条件付き銘柄分離: PASS
- Windows再検証: 61 tests、coverage 81.59%、formatter/lint/type PASS
...
- Data Gate: UNKNOWN、Signal生成・Phase 3への引渡し停止、H2-3へ送付
