...
| `P5R2-UNK-TF-002` | 集約をRun時に行うか、derived cacheを事前生成するか。 | P5R2-02〜03 | Data Catalog・provenance・性能Acceptanceを確定しない。 |
...
| `P5R2-UNK-HD-002` | Data一覧の単位、必須列、使用可能判定、更新・重複・取消・再試行。 | P5R2-02〜03 | Catalog API／UI／永続化を確定しない。 |
