...
| 改訂 | 2026-08-11 改訂2。DB・Persistence詳細設計とER図がP4-03の保存契約を実装へ渡す必須成果物であるため、P4-04Bへ追加し、UIをP4-04C、RED／Run ManifestをP4-04Dへ繰り下げ、P4-05〜10の入力・受入条件へ反映する。 |
