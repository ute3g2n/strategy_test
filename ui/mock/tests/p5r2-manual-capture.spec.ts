...
test('P5R2-22: current manual journey is assert-first and bounded', async ({ page }, testInfo) => {
  ...
  await expect(generationForm.locator('#p5r2-generation-start')).toHaveValue('2025-02-24T00:00:00Z')
  await expect(generationForm.locator('#p5r2-generation-end')).toHaveValue('2025-02-24T03:00:00Z')
