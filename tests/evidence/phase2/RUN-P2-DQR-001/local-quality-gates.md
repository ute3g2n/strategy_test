...
| test | `python -m scripts.quality_gate.local_p2_pytest` | PASS（26 passed） |
| coverage | `pytest tests/market_data --cov=autotrade.market_data --cov-fail-under=80` | PASS（82.68%） |
