"""Run the fixed P3-07R-04 Backtest contract tests with a local network guard."""
...
def _deny_network(*args: object, **kwargs: object) -> None:
    del args, kwargs
    raise RuntimeError("P3-07R-04 quality gate forbids outbound network access")
...
def main() -> int:
    ...
    result = pytest.main(["tests/backtest", "--runxfail", "-q"], plugins=[plugin])
